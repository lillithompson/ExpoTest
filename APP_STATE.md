...
- Toolbar actions: Reset, Flood (tap) / Flood Complete (long press), Reconcile (tap) / Controlled Randomize (long press), Selection tool, Mirror Horizontal toggle, Mirror Vertical toggle.
