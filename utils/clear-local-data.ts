...
/**
 * Removes all local data from AsyncStorage: saved files, tile sets (and bakes), and favorites.
 * Callers should then reset in-memory state (e.g. clearAllFiles, reloadTileSets, clearFavorites).
 */
